...
import type { Body_login_login_access_token,Message,NewPassword,Token,UserPublic,UpdatePassword,UserCreate,UserRegister,UsersPublic,UserUpdate,UserUpdateMe,ItemCreate,ItemPublic,ItemsPublic,ItemUpdate,Category,CategoryCreate,CategoryPublic,CategoryUpdate } from './models';
 ...
 * Get categories with optional skip and limit parameters.
	 ...
	 * @throws ApiError
	 */
	public static categoriesReadCategories(data: TDataCategoriesReadCategories = {}): CancelablePromise<Array<Category>> {
		const {
limit = 100,
skip = 0,
} = data;
	 ...
	 * @throws ApiError
	 */
	public static categoriesCreateCategory(data: TDataCategoriesCreateCategory): CancelablePromise<CategoryPublic> {
		const {
requestBody,
} = data;
		return __request(OpenAPI, {
	 ...
	 * @throws ApiError
	 */
	public static categoriesReadCategory(data: TDataCategoriesReadCategory): CancelablePromise<CategoryPublic> {
		const {
id,
} = data;
		return __request(OpenAPI, {
	 ...
	 * @throws ApiError
	 */
	public static categoriesUpdateCategory(data: TDataCategoriesUpdateCategory): CancelablePromise<CategoryPublic> {
		const {
id,
requestBody,
} = data;
	 ...
	 * @throws ApiError
	 */
	public static categoriesDeleteCategory(data: TDataCategoriesDeleteCategory): CancelablePromise<Message> {
		const {
id,
} = data;
		return __request(OpenAPI, {
