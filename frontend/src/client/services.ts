...
export class LoginService {
  ...
  public static loginLoginAccessToken(
    data: TDataLoginLoginAccessToken
  ...
  public static loginRecoverPassword(
    data: TDataLoginRecoverPassword
  ...
  public static loginRecoverPasswordHtmlContent(
    data: TDataLoginRecoverPasswordHtmlContent
...
export class UsersService {
  ...
  public static usersUpdatePasswordMe(
    data: TDataUsersUpdatePasswordMe
  ): CancelablePromise<Message> {
    const { requestBody } = data;
    return __request(OpenAPI, {
      method: 'PATCH',
...
export class CategoriesService {
  ...
  public static categoriesReadCategories(
    data: TDataCategoriesReadCategories = {}
  ): CancelablePromise<CategoriesPublic> {
    const { limit = 100, skip = 0 } = data;
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static categoriesCreateCategory(
    data: TDataCategoriesCreateCategory
   ...
   * @throws ApiError
   */
  public static categoriesReadCategory(
    data: TDataCategoriesReadCategory
  ): CancelablePromise<CategoryPublic> {
    const { id } = data;
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static categoriesUpdateCategory(
    data: TDataCategoriesUpdateCategory
  ): CancelablePromise<CategoryPublic> {
    const { id, requestBody } = data;
    return __request(OpenAPI, {
      method: 'PUT',
  ...
  public static categoriesDeleteCategory(
    data: TDataCategoriesDeleteCategory
  ): CancelablePromise<Message> {
    const { id } = data;
    return __request(OpenAPI, {
      method: 'DELETE',
